const fs = require('fs');
let content = fs.readFileSync('src/components/NationalitySelector.tsx', 'utf8');

// we'll rewrite the component entirely
...
`
fs.writeFileSync('src/components/NationalitySelector.tsx', content);
