...
newContent = newContent.replace(
  /<h4 className="text-sm font-semibold text-slate-900 dark:text-white flex items-center gap-1">/g,
...
newContent = newContent.replace('{activeMoment && (', modalHtml + '\n      {activeMoment && (');

fs.writeFileSync('src/components/Feed.tsx', newContent);
